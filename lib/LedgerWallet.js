    ...
    (0, _createClass3.default)(LedgerWallet, [{
        ...
        value: function () {
            var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(callback) {
                ...
                var addresses, pathComponents, cleanupCallback, transport, eth, addr, i, path, address;
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 11:
                                ...
                                eth = new _hwAppEth2.default(transport);
                                _context3.next = 15;
                                return eth.getAddress("44'/60'/0'/0/0", false, false);
                                            ...
                                            while (1) {
                                                switch (_context4.prev = _context4.next) {
                                                    ...
                                                    case 9:
                                                        ...
                                                        eth.signTransaction(addressToPathMap[txData.from.toLowerCase()], hex).then(function (result) {
                                                            console.log(result);
